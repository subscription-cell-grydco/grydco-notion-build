...
const postTog = p => tog(`${p.day}  ·  ${p.type}  ·  ${p.collection || p.intent}`, [
  bul(`Intent: ${p.intent}`),
  bul(`Hook / Objective: ${p.hook}`),
  bul(`Image Copy: ${p.copy}`),
  bul(`Collection / Campaign: ${p.collection}`),
  p.brief && p.brief !== '—' ? bul(`Brief / Reference: ${p.brief}`, p.brief.startsWith('http') ? p.brief : undefined) : bul('Brief / Reference: TBD'),
  bul(`Status: ${p.status}`),
]);
const storyTog = s => tog(`${s.day}  ·  Story  ·  ${s.intent}`, [
  bul(`Content: ${s.copy}`),
  s.link ? bul(`Link: ${s.link}`, s.link) : bul('Link / Swipe-up: —'),
...
const CAL = {
  "Karan Kothari Jewellers": { smm:"Vanshika", niche:"Premium Bridal & Heritage Jewellery", ig:"@karankotharijewellers",
    posts:[
      ...
      {day:"5 Jun",type:"Reel",intent:"Engagement",hook:"Product Desire + Family Legacy + Saves",copy:"The Plain Gold Jewellery Collection — bridal chokers, long haars, bangles and statement sets made for every wedding moment. Flat 9% Making Charges on Plain Gold.",collection:"Plain Gold",brief:"https://pin.it/7Hv407Zzm",status:"Approved"},
      {day:"6 Jun",type:"Reel",intent:"Filler",hook:"Offer Curiosity + Reach",copy:"TBD",collection:"—",brief:"—",status:"Brief Pending"},
      ...
      {day:"10 Jun",type:"Carousel",intent:"Engagement",hook:"Wedding season essentials — Saves",copy:"Four pieces. Endless combinations. The statement necklace. The stacking bangles. The cocktail ring. The ear cuff.",collection:"Statement Edit",brief:"—",status:"Brief Pending"},
      ...
      {day:"15 Jun",type:"Post",intent:"BTS / Filler",hook:"Behind the scenes — curiosity + trust",copy:"This is where it all begins. Behind every piece is hours of craft, care and precision.",collection:"Studio BTS",brief:"—",status:"In Design"},
    ...
    stories:[
      ...
      {day:"3 Jun",intent:"Product",copy:"New arrivals — Bridal chokers. Come see us.",link:null,status:"Scheduled"},
      {day:"5 Jun",intent:"Engagement",copy:"Poll: Gold or diamonds for your wedding?",link:null,status:"Scheduled"},
      {day:"7 Jun",intent:"BTS",copy:"Meet our karigars — watch this",link:null,status:"Scheduled"},
  ...
  "Aarni by Sharavani": { smm:"Tia", niche:"Fine Jewellery — Solitaires & Contemporary", ig:"@aarnibysharavani",
    posts:[
      {day:"5 Jun",type:"Reel",intent:"Brand awareness",hook:"These aren't just bangles... — Curiosity + Reach",copy:"Hand-forged. Stone-set. Made to be worn for decades. The Aarni Summer Collection is here.",collection:"Summer Collection",brief:"https://drive.google.com/",status:"Posted"},
      ...
      {day:"12 Jun",type:"Carousel",intent:"Sales",hook:"The edit you've been waiting for — Saves + DMs",copy:"Slide 1: The gold cuff. Slide 2: The stone drops. Slide 3: The layering set. Shop the Summer Edit.",collection:"Summer Collection",brief:"https://drive.google.com/",status:"In Design"},
      {day:"15 Jun",type:"Reel",intent:"Brand story",hook:"Made by hand. Worn with intent. — Saves",copy:"Every piece at Aarni begins the same way — with a sketch, a story, and a stone. This is how it's made.",collection:"Artisan Series",brief:"—",status:"Brief Pending"},
  ...
  "Atul Jewellers": { smm:"Vanshika", niche:"Traditional & Bridal Jewellery", ig:"@atuljewellers",
    posts:[
      {day:"2 Jun",type:"Reel",intent:"Brand / Seasonal",hook:"Bridal season is here. Are you ready? — Reach + DMs",copy:"The bridal collection you've been waiting for is now here. From heavy bridal sets to delicate pieces for every function.",collection:"Bridal 2025",brief:"—",status:"Posted"},
      ...
      {day:"9 Jun",type:"Carousel",intent:"Education",hook:"The complete bridal jewellery checklist — Saves",copy:"Slide 1: The bridal necklace. Slide 2: The maang tikka. Slide 3: The earring set. Slide 4: The bangles. Slide 5: The payal. All at Atul Jewellers.",collection:"Bridal Checklist",brief:"—",status:"In Design"},
      ...
      {day:"17 Jun",type:"Post",intent:"Offer",hook:"Wedding season special — book a consultation",copy:"Getting married this season? Book a private consultation at our showroom. Custom designs and resizing available.",collection:"—",brief:"—",status:"Brief Pending"},
      {day:"21 Jun",type:"Reel",intent:"Engagement",hook:"Before vs after the wedding — relatable + Comments",copy:"Before the wedding: saving for the perfect set. After the wedding: wondering how to store it beautifully. We have both covered.",collection:"Bridal",brief:"—",status:"Brief Pending"},
    ],
    stories:[
  ...
  "Bhagat Jewellers": { smm:"Tia", niche:"Classic Jewellery", ig:"@bhagatjewellers",
    posts:[
      ...
      {day:"5 Jun",type:"Post",intent:"Craft / Trust",hook:"Crafted with care. Worn for generations. — Trust + Saves",copy:"Our artisans put over 200 hours into every bridal set. That's not jewellery. That's legacy.",collection:"Bridal",brief:"—",status:"Brief Pending"},
      {day:"8 Jun",type:"Carousel",intent:"Education",hook:"Your complete bridal jewellery guide — Saves",copy:"Slide 1: The maang tikka. Slide 2: The necklace. Slide 3: The earrings. Slide 4: The bangles. Everything you need, one place.",collection:"Bridal Edit",brief:"—",status:"Brief Pending"},
      {day:"12 Jun",type:"Reel",intent:"Product",hook:"The piece that goes with everything — DMs + Saves",copy:"One necklace. Ten outfits. Zero compromises. Visit us in-store this week.",collection:"Everyday Collection",brief:"—",status:"Brief Pending"},
      {day:"16 Jun",type:"Post",intent:"Footfall",hook:"Walk in and find your piece — CTR",copy:"Walk in. Find your piece. Walk out feeling like royalty. Open 7 days, 10AM–8PM.",collection:"—",brief:"—",status:"Brief Pending"},
    ...
    stories:[
      ...
      {day:"14 Jun",intent:"BTS",copy:"Behind the showcase — our artisans",link:null,status:"Brief Pending"},
    ]
  },
  "Beri Jewellers": { smm:"Vanshika", niche:"Statement Jewellery", ig:"@berijewellers",
    posts:[
      ...
      {day:"4 Jun",type:"Carousel",intent:"Styling",hook:"Stack it. Layer it. Own it. — Saves",copy:"Slide 1: The single bold bangle. Slide 2: The stacked set. Slide 3: The full arm party. Which are you?",collection:"Stack Edit",brief:"—",status:"Brief Pending"},
      {day:"7 Jun",type:"Post",intent:"Product",hook:"New drops you didn't know you needed — DMs",copy:"New arrivals just dropped. The cocktail rings you've been waiting for. Shop in-store or DM.",collection:"Cocktail Edit",brief:"—",status:"Brief Pending"},
    ...
    stories:[
      {day:"2 Jun",intent:"Offer",copy:"New in store — come see us today",link:null,status:"Scheduled"},
  ...
  "Gujranwala Jewellers": { smm:"Tia", niche:"Heritage Jewellery", ig:"@gujranwalajewellers",
    posts:[
      {day:"1 Jun",type:"Post",intent:"Brand / Heritage",hook:"A legacy of craft and trust — Brand recall",copy:"Every piece we create carries the heritage of Gujranwala. A legacy of craft, quality and trust — passed down for generations.",collection:"Heritage Collection",brief:"—",status:"Scheduled"},
      ...
      {day:"8 Jun",type:"Carousel",intent:"Education",hook:"Bridal sets that tell a story — Saves",copy:"Slide 1: The heavy full set. Slide 2: The medium set for functions. Slide 3: Light daily wear. Slide 4: Cocktail pieces. Every bride, every budget.",collection:"Bridal Sets",brief:"—",status:"Brief Pending"},
      ...
      {day:"16 Jun",type:"Post",intent:"Footfall",hook:"Book your consultation — CTR",copy:"Walk in any day this week and explore our full bridal collection. Custom orders welcome.",collection:"—",brief:"—",status:"Brief Pending"},
      {day:"21 Jun",type:"Carousel",intent:"Engagement",hook:"Then vs now — nostalgia + Saves + Shares",copy:"The jewellery our grandmothers wore. The jewellery our mothers wore. The jewellery we wear today. Heritage never goes out of style.",collection:"Heritage",brief:"—",status:"Brief Pending"},
    ],
    stories:[
  ...
  "Luminique": { smm:"Vanshika", niche:"Luxury Jewellery & Lifestyle", ig:"@luminique",
    posts:[
      ...
      {day:"4 Jun",type:"Post",intent:"Brand story",hook:"For those who know. — Aspirational + Saves",copy:"Luminique was created for a specific kind of woman. She doesn't follow trends. She sets them.",collection:"Brand",brief:"—",status:"In Design"},
      ...
      {day:"16 Jun",type:"Post",intent:"Community",hook:"The Luminique woman — identity + Comments",copy:"You don't wear Luminique to be noticed. You wear it because you know the difference.",collection:"Brand",brief:"—",status:"Brief Pending"},
    ...
    stories:[
      ...
      {day:"17 Jun",intent:"Product",copy:"The piece everyone's asking about this week",link:null,status:"Brief Pending"},
    ]
  },
  "Vidhi Sheth": { smm:"Tia", niche:"Contemporary Fine Jewellery", ig:"@vidhisheth",
    posts:[
      {day:"2 Jun",type:"Post",intent:"Brand",hook:"Contemporary fine jewellery for the modern woman — Brand recall",copy:"Fine jewellery designed for women who live fully. Contemporary, thoughtful, made to be worn every single day.",collection:"Everyday Fine",brief:"—",status:"Scheduled"},
      {day:"5 Jun",type:"Reel",intent:"Product",hook:"Your signature piece — DMs",copy:"Every woman has a piece that's unmistakably hers. What's yours? Shop the Vidhi Sheth collection.",collection:"Signature Collection",brief:"—",status:"In Design"},
      ...
      {day:"24 Jun",type:"Carousel",intent:"Education",hook:"How to care for fine jewellery — Saves + Shares",copy:"Storage tips. Cleaning guide. What to avoid. When to get it serviced. From us to you.",collection:"Care Guide",brief:"—",status:"Brief Pending"},
    ],
    stories:[
  ...
  "Avani": { smm:"Tia", niche:"Fine Jewellery — Branding Phase", ig:"@avani.jewels",
    posts:[], stories:[],
    note:"Currently in branding phase with Studio Ink (Brand Identity delivery: June 30). Social media content calendar activates July 2025 post brand launch.",
  },
  "Elmara": { smm:"Vanshika", niche:"Luxury Brand — Website Phase", ig:"@elmara",
    posts:[], stories:[],
    note:"Currently in website build phase with PixelCraft Studio (go-live: July 15). Social media content calendar activates August 2025.",
  },
};
...
// ── Strategy template ──────────────────────────────────────────────────────
function strategyBlocks(clientName, smm) {
  return [
    co(`Prepared by ${smm}  ·  Reviewed and signed off by Manika  ·  Finalised before calendar launch  ·  One strategy doc per month per client.`, '🎯'),
    div(),
    h2('🎯 Monthly Objectives'),
    bul('Primary goal: [e.g. Increase reach to X impressions / Drive X DMs / Grow followers by X this month]'),
    bul('Secondary goal: [e.g. Build brand authority / Push new collection launch / Drive footfall]'),
    bul('Reach target: ___  ·  Engagement rate target: ___%  ·  New followers: ___  ·  DMs/enquiries: ___'),
    div(),
    h2('📊 AIDA Framework'),
    h3('A — Attention  (how do we stop the scroll?)'),
    bul('First-frame visual: [describe what the opening image or frame should look like — colour, subject, movement]'),
    bul('On-screen text / hook copy: [the first line the viewer reads]'),
    bul('Reel — first 3 seconds approach: [pattern interrupt / bold statement / question / visual hook]'),
    h3('I — Interest  (why should they keep watching or reading?)'),
    bul('Content angle this month: [what is the interesting angle that gives this brand a fresh perspective]'),
    bul('Storytelling style: [ ] Hero story  [ ] Problem → Solution  [ ] Before & After  [ ] Aspirational  [ ] Educational'),
    bul('Key emotional trigger: [ ] Nostalgia  [ ] Aspiration  [ ] FOMO  [ ] Belonging  [ ] Pride  [ ] Curiosity'),
    h3('D — Desire  (what makes them want it?)'),
    bul('USP to highlight this month: [one unique thing about this brand to lead with this month]'),
    bul('Social proof to use: [ ] Heritage / legacy  [ ] Craftsmanship BTS  [ ] Testimonials  [ ] Awards / recognition'),
    bul('Aspirational positioning: [how should the viewer feel when they see this brand — loved / elevated / proud / bold]'),
    h3('A — Action  (what do we want them to do?)'),
    bul('Primary CTA: [ ] DM us  [ ] Visit the store  [ ] Call to book  [ ] Link in bio  [ ] Save this post  [ ] Tag a friend'),
    ...
    bul('Pillar 4 — Behind the Scenes: [studio, making process, karigars — what BTS content is available]'),
    bul('Pillar 5 — Education: [what to teach the audience — caring for jewellery / buying guide / trend education]'),
    bul('Pillar 6 — Community & Engagement: [polls, relatable moments, questions, UGC prompts, reposts]'),
    bul('Pillar ratios this month: [ ] More product  [ ] More brand  [ ] Balanced  ← Choose one and plan calendar accordingly'),
    div(),
    h2('📣 Monthly Campaigns'),
    tog('Campaign 1 — [Campaign name]', [
      bul('Dates: [start date] → [end date]'),
      bul('Content types: [ ] Reels  [ ] Posts  [ ] Carousels  [ ] Stories  [ ] Ad creatives'),
      bul('Ad support: [ ] Meta  [ ] Google  [ ] No ads this campaign'),
      bul('Goal: [ ] Awareness  [ ] DMs / Leads  [ ] Sales / footfall  [ ] Follower growth'),
      bul('Key message (one line): [what is the campaign saying — the core idea]'),
      bul('Hashtag / caption theme: [campaign-specific hashtag or phrase]'),
    ]),
    tog('Campaign 2 — [Add if applicable, else delete]', [
      bul('Dates: [start] → [end]'),
    ...
    div(),
    h2('🧲 Lead Magnets'),
    bul('Lead magnet 1: [e.g. Free styling consultation — DM to book / Bridal checklist — save this post]'),
    bul('Lead magnet 2: [e.g. Making charge offer — limited time / Private viewing — limited slots]'),
    bul('Lead magnet 3: [e.g. Custom order inquiry / New collection preview — DM for early access]'),
    bul('Story CTA: [specific DM prompt or swipe-up action for stories this month — different from feed CTA]'),
    div(),
    h2('#️⃣ Hashtag Strategy'),
    bul(`Brand hashtags: #${clientName.toLowerCase().replace(/\s/g,'').replace(/'/g,'')} #[collection name] #[campaign name if any]`),
    bul('Industry: #jewellery #indianjewellery #jewellerylovers #handcraftedjewellery #goldenjewellery'),
    bul('Niche: [specific to this brand — e.g. #bridaljewellery #finejewellery #luxuryjewellery #statementjewellery]'),
    bul('Community: #weddingseason #bridesofinstagram #indianbride #jewelleryofinstagram #jewelleryaddict'),
    bul('Location: #delhi #delhijewellery #[client city if applicable]'),
    bul('Trending this month: [add 2–3 currently trending hashtags relevant to the brand — check weekly]'),
    div(),
    h2('🔍 Competitor & Trend Notes'),
    bul('What are competitors doing that is working this month? [1–2 observations from Instagram research]'),
    bul('Content format / audio to test: [trending reel style, audio, or format to experiment with]'),
    bul('What NOT to do: [based on what looks oversaturated or off-brand in the market right now]'),
    div(),
    h2('✅ Strategy Sign-off'),
    bul('SMM prepared: _______ on _______'),
    bul('Team Lead reviewed: Manika on _______'),
    bul('Client briefed on monthly direction: [ ] Yes  [ ] No — not required this month'),
  ];
}

// ── Assets template ────────────────────────────────────────────────────────
function assetsBlocks(clientName) {
  return [
    co(`All file links and brand references for ${clientName}. Paste Google Drive or Dropbox folder links as you create them. Keep this updated every month.`, '🗂️'),
    div(),
    h2('📁 Drive Folders — paste links below'),
    bul('Raw Photos (current month): [Paste Google Drive link]'),
    bul('Approved Posts — ready for upload: [Paste Google Drive link]'),
    bul('Brand Assets (logo, fonts, colours, guidelines): [Paste link]'),
    bul('Video Files & Reels: [Paste link]'),
    bul('Shoot Deliverables Archive: [Paste link]'),
    bul('Monthly Reports: [Paste link]'),
    div(),
    h2('🎨 Brand Reference'),
    bul('Instagram Handle: [Handle]'),
    bul('Brand Colours (hex): [e.g. #C5A028, #1A1A1A, #F5F0E8]'),
    bul('Brand Fonts: [Primary font name · Secondary font name]'),
    bul('Brand Tone: [e.g. Aspirational, warm, trustworthy / Bold, confident, unapologetic]'),
    bul('Watermark / brand logo placement: [bottom right / bottom centre / no watermark]'),
    bul('Do-not-use elements: [add anything the client has specifically said to avoid]'),
    div(),
    h2('📌 Recurring Notes'),
    bul('Posting schedule: [e.g. Mon / Wed / Fri + daily stories]'),
    bul('Caption language: [ ] English  [ ] Hindi  [ ] Hinglish  [ ] Mix'),
    bul('Tagging preferences: [other handles to always tag / never tag]'),
    bul('Client contact for approvals: [Name · WhatsApp number]'),
    bul('Any other brand-specific notes the team should always remember:'),
  ];
}
...
function createShootsDB(parentId) {
  return api('POST', 'databases', {
    ...
    properties: {
      ...
      'Shoot Type':    { select: { options: [
        {name:'Product Shoot',color:'blue'},{name:'Lifestyle Shoot',color:'green'},
        {name:'Bridal Shoot',color:'pink'},{name:'Reel Shoot',color:'purple'},
      ] } },
      'Vendor':        { select: { options: [
        {name:'Studio Kiran',color:'orange'},{name:'Lens & Light',color:'blue'},{name:'Other',color:'gray'},
      ] } },
      'Status':        { select: { options: [
        {name:'Planned',color:'gray'},{name:'Upcoming',color:'yellow'},{name:'Delivered',color:'green'},{name:'Cancelled',color:'red'},
      ] } },
...
// ── Main ───────────────────────────────────────────────────────────────────
async function main() {
  log('Building Gryd Co. Workspace v3...');

  // ── 1. FOUNDER DASHBOARD ────────────────────────────────────────────────
  log('Building 🏠 Founder Dashboard...');
  const dash = await mkPage(GS, '🏠 Founder Dashboard', '🏠');
  await add(dash.id, [
    co('Central command for Gryd Co. — client health, team workload, ad performance, deadlines, and action items at a glance. Updated by Manika daily.', '🏠'),
    div(),
    h2('📋 Client Overview — June 2025'),
    tbl(5, true, [
      row(['Client','SMM','Services','Ad Budget / mo','Status']),
      row(['Aarni by Sharavani','Tia','SMM + Ads','₹65,000','Active']),
      row(['Atul Jewellers','Vanshika','SMM + Ads + Branding','₹50,000','Active']),
      row(['Bhagat Jewellers','Tia','SMM only','—','Active']),
      row(['Beri Jewellers','Vanshika','SMM + Ads','₹30,000','Active']),
      row(['Gujranwala Jewellers','Tia','SMM + Ads','₹35,000','Active']),
      row(['Luminique','Vanshika','SMM + Ads + Branding','₹55,000','Active']),
      row(['Vidhi Sheth','Tia','SMM only','—','Active']),
      row(['Karan Kothari Jewellers','Vanshika','SMM + Ads','₹25,000','Active']),
      row(['Avani','Tia','Branding (phase)','—','Branding — June 30']),
      row(['Elmara','Vanshika','Website (phase)','—','Website — July 15']),
    ]),
    div(),
    h2('💰 Ad Budget Snapshot — June 2025'),
    tbl(5, true, [
      row(['Client','Budget','Spent','Remaining','Status']),
      row(['Aarni by Sharavani','₹65,000','₹27,000','₹38,000','42% used']),
      row(['Beri Jewellers','₹30,000','₹22,000','₹8,000','73% used — watch']),
      row(['Gujranwala Jewellers','₹35,000','₹14,000','₹21,000','40% used']),
      row(['Atul Jewellers','₹50,000','₹28,000','₹22,000','56% used']),
      row(['Luminique','₹55,000','₹47,000','₹8,000','⚠️ 85% used — near limit']),
      row(['Karan Kothari','₹25,000','₹0','₹25,000','Draft — not live']),
    ]),
  ]);
  await add(dash.id, [
    div(),
    ...
    bul('🔴 Luminique — ad budget 85% used, still 2 weeks left in June → Pratyusha to review pacing'),
    ...
    bul('🟡 Luminique — revision needed: warmer tones across all posts → Vanshika in progress'),
    div(),
    h2('🔗 Quick Access'),
    h3('Operations'),
  ...
  await add(hub.id, [
    co('10 client folders. Each contains: monthly content calendar (posts + stories), monthly strategy (AIDA + pillars + campaigns), assets & file links, and shoot briefs where applicable.', '👥'),
    div(),
    h2('How to use this hub'),
    num('SMM opens their client folder at the start of each month'),
    num('Fill the Strategy page first — AIDA, pillars, campaigns, lead magnets, hashtags'),
    num('Get strategy signed off by Manika before building the calendar'),
    num('Fill the Content Calendar with all posts and stories for the month'),
    num('Hand off to designers once Status = Brief Ready (or Approved for rush items)'),
    num('Update Status in real time as posts move through the pipeline'),
    div(),
    h2('Status key'),
    bul('Brief Pending → SMM has not yet written the brief or copy'),
    bul('In Design → Designer has picked up and is working on it'),
    bul('Review → Ready for TL review'),
    bul('Approved → TL has approved, ready to send to client'),
    bul('Sent to Client → Client approval pending'),
    bul('Scheduled → Client approved, scheduled for posting'),
    bul('Posted → Live on Instagram'),
    div(),
  ]);
  log(`  ✅ Hub: ${u(hub.id)}`);
  ...
  for (const [name, d] of Object.entries(CAL)) {
    log(`  Building folder: ${name}...`);
    const clientPg = await mkPage(hub.id, name, '📁');
    await add(clientPg.id, [
      co(`SMM: ${d.smm}  ·  Niche: ${d.niche}  ·  ${d.ig}`, '📁'),
      div(),
    ]);
    ...
    if (!d.posts.length) {
      await add(cal.id, [
        co(`SMM: ${d.smm}  ·  ${name}  ·  June 2025`, '📅'),
        div(),
        co(d.note, '⏳'),
        bul('Create calendar here once brand goes live — duplicate this page and rename for the active month.'),
      ]);
    } else {
      await add(cal.id, [
    ...
    if (clientShoots.length) {
      ...
      for (const sh of clientShoots) {
        sb.push(tog(`${sh.date}  ·  ${sh.type}  ·  ${sh.vendor}  ·  Status: ${sh.status}`, [
          ...
          bul('Drive Link (assets after delivery): [Paste here]'),
        ]));
      }
      await add(shootPg.id, sb);
      log(`    ✅ Shoot Brief: ${u(shootPg.id)}`);
    }
  }

  // ── 4. PHOTOSHOOTS DATABASE ─────────────────────────────────────────────
  log('Building 📸 Photoshoots database...');
  const shootsParent = await mkPage(GS, '📸 Photoshoots', '📸');
  await add(shootsParent.id, [
    co('All Gryd Co. photoshoots — past, upcoming, and planned. Filter by Client, Month, Status, or Vendor.', '📸'),
    div(),
    h2('June 2025 — Quick Summary'),
    tbl(5, true, [
      row(['Client','Type','Date','Delivery','Status']),
      ...SHOOTS.filter(s => s.month === 'June 2025').map(s =>
        row([s.brand, s.type, s.date, s.delivery, `${s.status}${s.edits ? ' · Edits ✅' : ''}`])
      ),
    ]),
    div(),
    h2('May 2025 — Archive'),
    tbl(5, true, [
      row(['Client','Type','Date','Delivery','Edits Received']),
    ...
    div(),
    co('The Photoshoots Tracker database below gives you a full filterable table view. Use it to filter by client, vendor, status, or month.', '📊'),
  ]);
  const db = await createShootsDB(shootsParent.id);
  log(`  Photoshoots DB created: ${u(db.id)}`);
  for (const s of SHOOTS) {
    await addShootRow(db.id, s);
    log(`    Row: ${s.brand} — ${s.type}`);
  }
  ...
  await add(wf.id, [
    co('Daily tracking source for the team. Every task is logged with owner, type, status, and completion date. Manika reviews this each morning.', '📋'),
    div(),
    h2('What to log'),
    bul('Every deliverable: strategy decks, reel briefs, calendar builds, design files, ad campaigns, reports, client communications'),
    ...
    div(),
    h2('Properties to fill — every task, every day'),
    tbl(3, true, [
      row(['Property','What to fill','Why it matters']),
      row(['Task Name','Specific: "June reel brief — KK x4", not just "Brief"','Manika needs to know exactly what is being done']),
      row(['Brand','The client this task is for','Helps see per-client workload']),
      ...
      row(['Due Date','When it must be done — set by Manika or client deadline','Priority signal']),
      row(['Completed On','Fill when you mark Done','Shows actual task duration — honest data only']),
    ]),
    div(),
    h2('Status rules'),
    bul('Blocked: use only when you cannot proceed until someone else acts. Add a note explaining what you need and from whom.'),
    bul('In Progress for more than 2 days: add a note or flag to Manika — something may be wrong'),
    bul('Done means 100% done — not "sent for review" or "almost"'),
    div(),
    h2('Daily routine for the team'),
    num('Morning (before 10 AM): check your tasks. Update any status changes from yesterday.'),
    num('During the day: update Status as you move forward. Log new tasks as they come in.'),
    num('End of day: mark Done tasks with today\'s Completed On date. Flag anything carrying over.'),
    div(),
    h2('Daily routine for Manika'),
    num('Morning: filter Status = Blocked → resolve each one'),
    num('Morning: filter Due Date = today → confirm these will be done'),
    num('Anytime: filter Status = Review → review and move to Approved or send back'),
    div(),
  ...
  // ── Summary ─────────────────────────────────────────────────────────────
  console.log('\n══════════════════════════════════════════════════════════════');
  console.log('   ✅  Gryd Co. Workspace v3 — COMPLETE');
  console.log('══════════════════════════════════════════════════════════════');
  console.log(`\n🏠  Founder Dashboard      → ${u(dash.id)}`);
  console.log(`👥  Client Operations Hub  → ${u(hub.id)}`);
  console.log(`     10 client folders, each with: Calendar · Strategy · Assets · Shoot Briefs`);
  console.log(`📸  Photoshoots            → ${u(shootsParent.id)}`);
  console.log(`     Includes filterable database (${SHOOTS.length} shoots seeded)`);
  console.log(`📋  Workflow Guide         → ${u(wf.id)}`);
  console.log(`\n📌  MOVE THESE to Grydco's HQ in Notion (right-click → Move to):`);
  console.log('    🏠 Founder Dashboard → replace the old one');
  console.log('    👥 Client Operations Hub → inside ⚙️ Operations');
  console.log('    📸 Photoshoots → inside ⚙️ Operations or 🎨 Projects');
  console.log('    📋 Workflow Guide → inside ⚙️ Operations');
}
